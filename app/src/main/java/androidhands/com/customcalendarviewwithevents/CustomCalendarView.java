...
public class CustomCalendarView extends LinearLayout {
    ...
    public CustomCalendarView(final Context context, @Nullable AttributeSet attrs) {
        ...
        gridView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Button lessNumber = findViewById(R.id.removeNumber);
                lessNumber.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        TextView textView = findViewById(R.id.textNumber);
                        textView.setText(Integer.parseInt(textView.getText().toString()) - 1);
    ...
    private void IntializeLayout() {
        ...
        onlineText = view.findViewById(R.id.onlineText);
    }

    private void SetUpCalendar() {
        String currwntDate = dateFormat.format(calendar.getTime());
        CurrentDate.setText(currwntDate);
        onlineText.setText(MainActivity.stringBuilder.toString());
        dates.clear();
